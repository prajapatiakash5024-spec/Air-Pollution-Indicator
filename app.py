...
AQI_SCALE = [
    (0,   50,  "Good",         "#a8e6cf"),
    (51,  100, "Satisfactory", "#dcedc1"),
    (101, 200, "Moderate",     "#ffd3b6"),
    (201, 300, "Poor",         "#ffaaa5"),
    (301, 400, "Very Poor",    "#ff8b94"),
    (401, 500, "Severe",       "#a8d8ea"),
]
    ...
    with col_left:
        ...
        fig_map = go.Figure(go.Scattermapbox(
            ...
            marker=dict(
                ...
                color=dff2["AQI"],
                colorscale=[
                    [0.00, "#a8e6cf"], [0.10, "#a8e6cf"],
                    [0.10, "#dcedc1"], [0.20, "#dcedc1"],
                    [0.20, "#ffd3b6"], [0.40, "#ffd3b6"],
                    [0.40, "#ffaaa5"], [0.60, "#ffaaa5"],
                    [0.60, "#ff8b94"], [0.80, "#ff8b94"],
                    [0.80, "#a8d8ea"], [1.00, "#a8d8ea"],
                ],
                cmin=0, cmax=500,
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    fig_radar.add_trace(go.Scatterpolar(
        ...
        marker=dict(color='#a8e6cf', size=7)
    ))
    ...
    bar_colors = [
        "#a8e6cf" if v <= safe_val else
        "#ffd3b6" if v <= safe_val * 1.5 else "#ff8b94"
    ...
    fig_hbar.add_vline(
        x=safe_val, line_dash="dash", line_color="#ff8b94",
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    fig_state = px.bar(
        ...
        color="Avg",
        color_continuous_scale=[[0, "#a8e6cf"], [0.4, "#ffd3b6"], [0.7, "#ff8b94"], [1, "#a8d8ea"]],
        range_color=[0, 500],
